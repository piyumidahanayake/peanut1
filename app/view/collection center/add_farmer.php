...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Add farmer - <?php echo $_SESSION['user_name']?></title>
...
sup{
  ...
  <?php include_once('header.php'); ?>
      ...
      <a href="<?php echo URLROOT; ?>/Collectioncenterpages/deliveredorders"><i class="fas fa-bars"><span></i>Completed orders</span></a>
        ...
        <button class="dropdown-btn " >
          ...
          <a  href="<?php echo URLROOT; ?>/Collectioncenterpages/farmers"><i class="fas fa-bars"><span></i>Farmer mangement</span></a>
            <a style="background-color: rgba(24, 23, 23, 0.8)" href="<?php echo URLROOT; ?>/Collectioncenterpages/addfarmers"><i class="fas fa-bars"><span></i>Add farmer</span></a>
   ...
   <!-- <div class="form-header">
      ...
      <form method="POST" action="<?php echo URLROOT; ?>/collectioncenterpages/addfarmers">
      <div class ="form-header" style="text-align:left;color:#006b38ff;padding:0px;font-family:bevan;font-size: 35px;text-align: center;"><h1 style="color:#006b38ff">Add New Farmer</h1></div>
        <div class="form-group">
          <label for="nic">National Identity Card Number<sup>*</sup></label>
          <input id="nic" type="text" name="nic"  value="<?php echo $data['nic']; ?>" />
          <span id="name" class="invalid-feedback"><?php echo $data['nic_err']; ?></span>
        </div>
        <div class="form-group">
          <label for="name">Full Name<sup>*</sup></label>
          <input id="name" type="text" name="name"  value="<?php echo $data['name']; ?>" />
          <span id="name" class="invalid-feedback"><?php echo $data['name_err']; ?></span>
        </div>
        <div class="form-group">
          <label for="address">Home Address<sup>*</sup></label>
          <input id="address" type="text" name="address"  value="<?php echo $data['address']; ?>"/>
          <span id="name" class="invalid-feedback"><?php echo $data['address_err']; ?></span>
        </div>
        <div class="form-group">
          <label for="con_number">Contact Number<sup>*</sup></label>
          <input id="con_number" type="text" name="con_number" value="<?php echo $data['con_number']; ?>"/>
        ...
        <div class="btn-block">
                <button style="background-color:#006b38ff" id="submit"type="submit" href="/">Submit</button>
              </div>
       <!-- <div class="form-group">
