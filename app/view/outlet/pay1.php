...
<table><tr><td width="0px"></td><td width="100px"><h5> Invoice No:</h5></td><td>
                <div class="item"><?php echo $data['id']?><input type="hidden" name="invoice_no" id="SpecialTwwo" value="<?php echo $data['id']?>" required/>
              </div></td></tr>
</table>  

<table><tr><td width="0px"></td><td width="100px"><h5> Amount (Rs):</h5></td><td>
                <div class="item"><input type="number" name="amount" step="0.01" min="1" max="<?php echo $data['st']?>" id="SpecialTwwo" value="<?php echo $data['st']?>.00"  required/>
              </div></td></tr>
</table>
<br>
