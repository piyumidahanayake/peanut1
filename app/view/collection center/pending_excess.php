...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Pending Excess - <?php echo $_SESSION['user_name'];?></title>
...
width: (100% - 250px); margin-top: 60px;padding: 20px;margin-left: 250px;background: url('<?php echo URLROOT; ?>/img/background.jpg') no-repeat;
  ...
  <div class="sidebar">
    ...
    <div class="dropdown-container ">
      ...
      <a href="<?php echo URLROOT; ?>/Collectioncenterpages/deliveredorders"><i class="fas fa-bars"><span></i>Delivered orders</span></a>
        ...
        <div class="dropdown-container drop-active">
          ...
          <a style="background-color: rgba(24, 23, 23, 0.8)" href="<?php echo URLROOT; ?>/Collectioncenterpages/pendingExcess"><i class="fas fa-bars"><span></i>Pending Excess</span></a>
        </div>
        <button class="dropdown-btn">
    ...
    <div class="content">
        <div class="new">
            <div class="topnav">
                <a  href="<?php echo URLROOT; ?>/Collectioncenterpages/pendingExcess">Pending Excesses </a>
              ...
              <table id="customers">
                ...
                <?php foreach($data['result'] as $excess) : ?>
                <tr>
                <td name="id" value="hdh"><?php echo $excess->id?></td>
                    <td><?php echo $excess->ordered_date?></td>
                    <td><?php echo $excess->product_name?></td>
                    <td style="text-align:right"><?php echo $excess->quantity?></td>
                    <td class="td-center"><a style="background-color:white;border:0px"id="delete" href="<?php echo URLROOT; ?>/Collectioncenterpages/removeExcess?id=<?php echo $excess->id?>&quantity=<?php echo $excess->quantity?>pr_id=<?php echo $excess->product_id?>"><i class="fas fa-trash"></i></a></td>
                  </tr> 
                  <?php endforeach; ?>
