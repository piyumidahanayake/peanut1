...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Add excess - <?php echo $_SESSION['user_name']?></title>
        ...
        <div class="shopping-cart">
            ...
            <?php foreach($data['products'] as $products) : ?>
              ...
              <div class="item">
                ...
                <div class="buttons">
                <input class="button1" type="submit" value="Add To Excess">
                </div>
                ...
                <div class="description">
                 ...
                 <p></p>
                  ...
                  <span class="warning" style="color:#ff4444"  id="warning"></span>
                ...
                <div class="quantity">
                  ...
                  <input   oninput="my()" type="number" name="quantity" min="0" value="0">
...
function my(){
  ...
  add=Math.floor(y);
  if(isNaN(add)){
document.getElementById("warning").innerHTML="Enter numeric value";
}
else if(add>inHand){
  document.getElementById("warning").innerHTML="Enter less value than in hand";
}
else{
