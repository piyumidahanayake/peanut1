    ...
    public function createUserSession($user){
     ...
     $_SESSION['user_type'] = $user->type; 
      if($_SESSION['user_type']==1){
        ...
        redirect('Outletpages/home');
      }
      else if($_SESSION['user_type']==3){
        redirect('Ddriverpages/driverhome');
      }
      else if($_SESSION['user_type']==4){
        redirect('intermediateoperatorpages/home');
      }
      else if($_SESSION['user_type']==5){
        redirect('Adminpagesfi/home');
      }
      else if($_SESSION['user_type']==6){
        redirect('financialoperatorpages/home');
      }
