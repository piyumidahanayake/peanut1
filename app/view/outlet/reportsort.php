...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Display Order Report</title>
...
<table padding-top="0px">
      <tr> 
        ...
        <div class="btn-hlock" style="align:left; padding-bottom:13px; padding-right:10px; padding-left:10px;">
                <button type="select" href="/" disabled style="background: white;color:black">Sorted By</button> </div><td width="1020px">
                
</td>
  
<form action="<?php echo URLROOT; ?>/Outletpages/reportsort1" method="post">
<td>
  ...
  <tr>
    ...
    <td><?php echo $viewin->date1?></td>
     ...
     <td><a style="background-color:#013220;border-radius: 8px;" href="<?php echo URLROOT; ?>/Outletpages/rep?id=<?php echo $viewin->id?>">more</a></td>
