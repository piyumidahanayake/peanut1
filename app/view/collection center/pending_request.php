...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Previous Requests - <?php echo $_SESSION['user_name'];?></title>
...
<button class="dropdown-btn" ">
    ...
    <a style="background-color: rgba(24, 23, 23, 0.8)" href="<?php echo URLROOT; ?>/Collectioncenterpages/pendingRequest"><i class="fas fa-bars"><span></i>Previous requests</span></a>
    ...
    <div class="content">
        <div class="new">
            <div class="topnav">
                <a  href="<?php echo URLROOT; ?>/Collectioncenterpages/pendingREQUEST$request">Previous Requests </a>
              ...
              <table id="customers">
                ...
                <?php $s=".jpg";?>
                <?php foreach($data['result'] as $request) : ?>
                <tr>
                <td name="id" value="hdh"><?php echo $request->request_id?></td>
                    <td><img src="<?php echo URLROOT; ?>/img/vegetables/<?php echo $request->filename?>"></td>
                    <td><?php echo $request->requested_date?></td>
                    <td><?php echo $request->item_name?></td>
                    <td><?php echo $request->type?></td>
                    <td><?php echo $request->notes_or_details?></td>
                    <td class="td-center"><a style="background-color:white;border:0px"id="delete" onclick="deleterequest()"><i class="fas fa-trash"></i></a></td>
                  </tr> 
                  <?php endforeach; ?>
...
function deleterequest(){
  ...
  if (result.isConfirmed) {
    window.location.href = "<?php echo URLROOT; ?>/Collectioncenterpages/cancelrequest?id=<?php echo $request->request_id;?>";
  } else if (result.isDenied) {
    Swal.fire('Request was not cancelled')
  }
})
}
function search(){
