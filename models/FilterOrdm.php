<?php
  class FilterOrdm { 
    ...
    public function reportalltime($data){
      $this->db->query('SELECT * FROM orders LEFT JOIN order_description ON orders.order_id = order_description.order_id WHERE orders.delivery_status= "Received" AND orders.collection_center_id = :ccid ORDER BY orders.order_id ASC, orders.order_date ASC');
    ...
    public function reporttodate($data){
      $this->db->query('SELECT * FROM orders LEFT JOIN order_description ON orders.order_id = order_description.order_id WHERE orders.delivery_status= "Received" AND orders.collection_center_id = :ccid AND orders.order_date <= :to ORDER BY orders.order_id ASC, orders.order_date ASC');
      $this->db->bind(':ccid', $data['collection_center_id']);
    ...
    public function reportfromdate($data){
        $this->db->query('SELECT * FROM orders LEFT JOIN order_description ON orders.order_id = order_description.order_id WHERE orders.delivery_status= "Received" AND orders.collection_center_id = :ccid AND orders.order_date >= :from ORDER BY orders.order_id ASC, orders.order_date ASC');
        $this->db->bind(':ccid', $data['collection_center_id']);
    ...
    public function reportfromtodate($data){
      $this->db->query('SELECT * FROM orders LEFT JOIN order_description ON orders.order_id = order_description.order_id WHERE orders.delivery_status= "Received" AND orders.collection_center_id = :ccid AND orders.order_date >= :from AND orders.order_date <= :to  ORDER BY orders.order_id ASC, orders.order_date ASC');
      $this->db->bind(':ccid', $data['collection_center_id']);
      $this->db->bind(':from', $data['from_date']);
      $this->db->bind(':to', $data['to_date']);
      $results = $this->db->resultSet(); 
    ...
    public function reporvalltime($data){
      $this->db->query('SELECT * FROM orders LEFT JOIN order_description ON orders.order_id = order_description.order_id WHERE orders.delivery_status= "Received" AND orders.collection_center_id = :ccid ORDER BY orders.order_id ASC, order_description.ordered_quantity DESC');
      $this->db->bind(':ccid', $data['collection_center_id']);
    ...
    public function reporvtodate($data){
      $this->db->query('SELECT * FROM orders LEFT JOIN order_description ON orders.order_id = order_description.order_id WHERE orders.delivery_status= "Received" AND orders.collection_center_id = :ccid AND orders.order_date <= :to ORDER BY orders.order_id ASC, order_description.ordered_quantity DESC');
      $this->db->bind(':ccid', $data['collection_center_id']);
      $this->db->bind(':to', $data['to_date']);
    ...
    public function reporvfromdate($data){
        $this->db->query('SELECT * FROM orders LEFT JOIN order_description ON orders.order_id = order_description.order_id WHERE orders.delivery_status= "Received" AND orders.collection_center_id = :ccid AND orders.order_date >= :from ORDER BY orders.order_id ASC, order_description.ordered_quantity DESC');
        $this->db->bind(':ccid', $data['collection_center_id']);
        $this->db->bind(':from', $data['from_date']);
    ...
    public function reportalltime1($data){
      $this->db->query('SELECT * FROM orders LEFT JOIN order_description ON orders.order_id = order_description.order_id WHERE orders.delivery_status= "Received" AND orders.collection_center_id = :ccid ORDER BY orders.order_date ASC');
      $this->db->bind(':ccid', $data['collection_center_id']);
    ...
    public function reporttodate1($data){
      $this->db->query('SELECT * FROM orders LEFT JOIN order_description ON orders.order_id = order_description.order_id WHERE orders.delivery_status= "Received" AND orders.collection_center_id = :ccid AND orders.order_date <= :to ORDER BY orders.order_date ASC');
      $this->db->bind(':ccid', $data['collection_center_id']);
      $this->db->bind(':to', $data['to_date']);
    ...
    public function reportfromdate1($data){
        $this->db->query('SELECT * FROM orders LEFT JOIN order_description ON orders.order_id = order_description.order_id WHERE orders.delivery_status= "Received" AND orders.collection_center_id = :ccid AND orders.order_date >= :from ORDER BY orders.order_date ASC');
        $this->db->bind(':ccid', $data['collection_center_id']);
        $this->db->bind(':from', $data['from_date']);
    ...
    public function reportfromtodate1($data){
      $this->db->query('SELECT * FROM orders LEFT JOIN order_description ON orders.order_id = order_description.order_id WHERE orders.delivery_status= "Received" AND orders.collection_center_id = :ccid AND orders.order_date >= :from AND orders.order_date <= :to  ORDER BY orders.order_date ASC');
      $this->db->bind(':ccid', $data['collection_center_id']);
      $this->db->bind(':from', $data['from_date']);
      $this->db->bind(':to', $data['to_date']);
      $results = $this->db->resultSet(); 
    ...
    public function reporvalltime1($data){
      $this->db->query('SELECT * FROM orders LEFT JOIN order_description ON orders.order_id = order_description.order_id WHERE orders.delivery_status= "Received" AND orders.collection_center_id = :ccid ORDER BY order_description.value_after_delivery DESC');
      $this->db->bind(':ccid', $data['collection_center_id']);
    ...
    public function reporvtodate1($data){
      $this->db->query('SELECT * FROM orders LEFT JOIN order_description ON orders.order_id = order_description.order_id WHERE orders.delivery_status= "Received" AND orders.collection_center_id = :ccid AND orders.order_date <= :to ORDER BY order_description.value_after_delivery DESC');
      $this->db->bind(':ccid', $data['collection_center_id']);
      $this->db->bind(':to', $data['to_date']);
    ...
    public function reporvfromdate1($data){
        $this->db->query('SELECT * FROM orders LEFT JOIN order_description ON orders.order_id = order_description.order_id WHERE orders.delivery_status= "Received" AND orders.collection_center_id = :ccid AND orders.order_date >= :from ORDER BY order_description.value_after_delivery DESC');
        $this->db->bind(':ccid', $data['collection_center_id']);
        $this->db->bind(':from', $data['from_date']);
    ...
    public function reporvfromtodate1($data){
      $this->db->query('SELECT * FROM orders LEFT JOIN order_description ON orders.order_id = order_description.order_id WHERE orders.delivery_status= "Received" AND orders.collection_center_id = :ccid AND orders.order_date >= :from AND orders.order_date <= :to  ORDER BY order_description.value_after_delivery DESC');
      $this->db->bind(':ccid', $data['collection_center_id']);
      $this->db->bind(':from', $data['from_date']);
      $this->db->bind(':to', $data['to_date']);
      $results = $this->db->resultSet(); 
