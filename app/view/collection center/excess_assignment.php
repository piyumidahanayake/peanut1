    ...
    <div class="dropdown-container">
      ...
      <a href="<?php echo URLROOT; ?>/Collectioncenterpages/deliveredorders"><i class="fas fa-bars"><span></i>Delivered orders</span></a>
        ...
        <div class="dropdown-container drop-active">
          ...
          <a style="background-color: rgba(24, 23, 23, 0.8);" href="<?php echo URLROOT; ?>/Collectioncenterpages/excessAssignment"><i class="fas fa-bars"><span></i>Excess management</span></a>
        </div>
        <button class="dropdown-btn">
    ...
    <div class="content">
        <div class="new">
            ...
            <a  href="<?php echo URLROOT; ?>/Collectioncenterpages/pendingExcess">Pending Excesses </a>
                <a style="margin-right:0px; text-align:right" href="<?php echo URLROOT; ?>/Collectioncenterpages/excessAssignment">Assigned Excesses</a>
              </div>
              <table id="customers">
                <tr>
                  <th>Excess ID</th>
                ...
                <td name="id" value="hdh"><?php echo $excess->id?></td>
                    ...
                    <td><?php echo $excess->quantity?></td>
                    <td><?php echo $excess->status?></td>
                    <td><?php echo $excess->assigned_date?></td>
                    <td><?php echo $excess->assigned_quantity?></td>
