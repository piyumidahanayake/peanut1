...
<button class="dropdown-btn" >
    ...
    <div class="content">
        <div class="new">
            <div class="topnav">
            <a  href="<?php echo URLROOT; ?>/Collectioncenterpages/pendingNeccesity">Pending Neccesity </a>
                <a style="margin-right:0px; text-align:right" href="<?php echo URLROOT; ?>/Collectioncenterpages/neccesityAssignment">Assigned Neccesity</a>
              </div>
              <table id="customers">
                <tr>
