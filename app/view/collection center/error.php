...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Financial Operator - Home Page</title>
...
width: (100% - 250px); margin-top: 60px;padding: 20px;margin-left: 250px;background: url('<?php echo URLROOT; ?>/img/background.jpg') no-repeat;
  ...
  <?php include_once('header.php'); ?>
    ...
    <div class="content">
        <div class="testbox">
		 <form action="/">
              	<div>  <pre class="tabx" style="text-align:center; color:#006b38ff; padding:0px; font-family:bevan; font-size: 35px;">OOPS &nbsp&nbsp&nbsp&nbsp</pre> </div>

<table id="Home" align="center" >
  <tr>
  <td>&nbsp&nbsp Yor request cannot be completed! &nbsp&nbsp&nbsp&nbsp</td><td> </td>
  </tr>
  <tr> 
...
<div>  <pre class="tabx" style="text-align:center; color:#006b38ff; padding:0px; font-family:bevan; font-size: 30px;"> Request quantity should be lesser than In Hand Stock &nbsp&nbsp&nbsp&nbsp </pre> </div>
<button style="width:100px;border-radius:5px;border:2px solid black;float:center;text-decoration:none;color:black"><a style="text-decoration:none;color:black" href="<?php echo URLROOT; ?>/collectioncenterpages/addExcess">Try again</a></button>
		</form>
        </div>
    </div>
