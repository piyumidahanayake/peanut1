    ...
    <div class="content">
        <div class="new">
            <div class="topnav">
                ...
                <select id="mySelect" onchange="search()" style="float: right; padding: 6px;color:black;background-color:white;
  margin-top: 8px;
  margin-right: 16px;
  border: none;
  font-size: 17px;">
              ...
              <table id="customers">
                ...
                <?php foreach($data['result'] as $delivered_orders) : ?>
                <tr <?php if($delivered_orders->delivery_status=="assigned"){?> style="background-color:#00FFFF"<?php echo "hdhf";}?>>
                    <td><?php echo $delivered_orders->id?></td>
                    <td><?php echo $delivered_orders->outlet_name?></td>
                    <td><?php echo $delivered_orders->delivery_date?></td>
                    <td><?php echo $delivered_orders->driver?></td>
                    <td class="td-center"><a href="<?php echo URLROOT; ?>/collectioncenterpages/deliveredordersmore?id=<?php echo $delivered_orders->id?>"> show details</a></td>
                  </tr>
                  <?php endforeach; ?>
              </table>
