...
<table id="Home" align="center" >
  <tr>
  <td>&nbsp&nbsp There are not pending broughts in the list! &nbsp&nbsp&nbsp&nbsp</td><td> </td>
  </tr>
  <tr> 
...
<div>  <pre class="tabx" style="text-align:center; color:#006b38ff; padding:0px; font-family:bevan; font-size: 30px;"> Try again with correct details &nbsp&nbsp&nbsp&nbsp </pre> </div>
		</form>
        </div>
    </div>
