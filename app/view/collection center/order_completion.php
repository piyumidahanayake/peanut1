  ...
  <div class="sidebar">
    ...
    <div class="content">
        <div class="testbox">
            ...
            <form action="<?php echo URLROOT; ?>/collectioncenterpages/assignment" method="post">
              ...
              <input style="display:none" type="text" name="order_id" value ="<?php echo $data['id']?>">
                <div class="table-header">
                  ...
                  <div class="col col-2">Ordered (kg)</div>
                  <div class="col col-4">In hand (kg)</div>
                  <div class="col col-3">Assigned quantity(kg)</div>  
               ...
               <?php foreach($data['order'] as $order) : ?>
                ...
                <div class="table-tx">
                  ...
                  <div id="stock" class="col col-4"><?php echo $order->center_stock?></div>
                  <div class="col col-3"><input id="inputValue" oninput="quantityValidation()" name="<?php echo $order->id?>" type="text" style="padding:0px;margin-left:15px;margin-top:0px;margin-bottom: auto;margin-top:auto;height:20px"></div>  
                ...
                <?php endforeach; ?>
              <div class="item">
                <p style="font-size: 14px;text-transform: uppercase; letter-spacing: 0.03em;">Set delivery Date</p>
