...
<html lang="en" dir="ltr">
  ...
  <div class="sidebar">
    ...
    <!--sidebar end-->
        ...
        <div class="card" style="margin-top:80px">
            ...
            <div class="info">
                ...
                <div class="row">
                    <div class="columnhead" style="font-size:larger> <span id="heading">Ordered Date</span><br> <span id="details"> <?php echo $data['order'][0]->order_date?></span> </div>
                    <div class="columnhead" style="font-size:larger> <span id="heading">Order No.</span><br> <span id="details"><?php echo $data['order'][0]->id?></span> </div>
                    <div class="columnhead" style="font-size:larger> <span id="heading">Assigned date</span><br> <span id="details"><?php echo $data['order'][0]->assigned_date?></span> </div>
                    <div class="columnhead" style="font-size:larger> <span id="heading">Routed date</span><br> <span id="details"><?php echo $data['order'][0]->delivery_date?></span> </div>
                </div>
            </div>
            <div class="pricing">
      ...
      font-size:large;">
              ...
              <?php foreach ($data['order'] as $order):?>
                <div class="row">
                    ...
                    <div class="column2" style="font-size:larger"> <span id="name"> <?php echo $order->product_name ?></span> </div>
                    <div class="column3" style="font-size:larger> <span id="price"> <?php echo $order->oredered_quantity ?>Kg</span> </div>
                    <div class="column3" style="font-size:larger> <span id="price"><?php echo $order->assigned_quantity ?>Kg </span> </div>
                </div>
                <?php endforeach; ?>
            ...
            <div class="total">
                <div class="row">
                     <input style="width:150px;color:white;margin-left:auto;margin-right:auto;background-color:#006b38ff;padding:10px ;cursor:pointer;
    ...
    height:30px;
    border-radius: 4px;
    border:2px solid black"type="submit" value="Save changes">
            </div>
        </div>
        </form>
    </div>
