...
<html lang="en" dir="ltr">
  <head>
    ...
    <style>
     ...
     .new{
        background-color: rgba(100,200,215, 0.1);
  ...
  <body>
   ...
   <option value="">Select Month</option>
        ...
        <option value="12">December</option></td>
             ...
             <div style="text-align: center;margin-top: 16px;font-size: 24px;"><b>FINANCIAL REPORT FOR <?php echo $data['m']?>th MONTH IN <?php echo $data['y']?></b></div>
              <table id="customers">
               <tr>
    <th>Week         </th>
...
?>
             ...
             <?php 
              $paid=0;
             foreach ($data['financial1'] as $financial1):
                  $paid=$paid+$financial1->amount;
              ?>
             ...
             ?>
             <div style="background: rgba(200,203,120, 0.8);">
 <div style="margin-left: 200px;margin-top: 70px;font-size: 25PX;color:blue;">Total Amount : <var style="margin-left:110PX">Rs.<?php echo $t_a ?>.00</div></var>
  <div style="margin-left: 200px;margin-top: 10px;font-size: 25PX;color:blue;">Profit for whole month : <var style="margin-left:10px">Rs.<?php echo $profit ?>.00</div></var> </div>   
            </div>
    </div>
