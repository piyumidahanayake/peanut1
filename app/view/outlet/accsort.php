...
<table id="customers" style="width: 800px;margin-left: 60px;border-radius: 18px">
  ...
  <tr>
    <td> <?php echo $viewin->id?></td>
    <td><?php echo $viewin->date1?></td>
    
     <td><a style="background-color:#013220;border-radius: 8px;" href="<?php echo URLROOT; ?>/Outletpages/accdetails?id=<?php echo $viewin->id?>">more</a></td>
